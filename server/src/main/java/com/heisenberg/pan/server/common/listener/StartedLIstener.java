package com.heisenberg.pan.server.common.listener;
...
public class StartedLIstener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent applicationReadyEvent) {
        ...
        log.info(AnsiOutput.toString(AnsiColor.BRIGHT_BLUE,"server started at "+ serverUrl));
    ...
    private boolean checkShowServerDoc(ConfigurableApplicationContext applicationContext) {
        return applicationContext.getEnvironment().getProperty("swagger2.show", Boolean.class, false) && applicationContext.containsBean("swagger2Config");
    }
}
